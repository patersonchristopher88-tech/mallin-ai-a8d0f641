  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ARIA — your personal AI assistant" },
      {
        ...
        content: "Talk, generate images, upload documents, customize everything. A holographic AI assistant inspired by JARVIS, FRIDAY, and Gideon.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ARIA — your personal AI assistant" },
      { name: "description", content: "Talk, generate images, upload documents, customize everything. A holographic AI assistant inspired by JARVIS, FRIDAY, and Gideon." },
      { property: "og:description", content: "Talk, generate images, upload documents, customize everything. A holographic AI assistant inspired by JARVIS, FRIDAY, and Gideon." },
      { name: "twitter:description", content: "Talk, generate images, upload documents, customize everything. A holographic AI assistant inspired by JARVIS, FRIDAY, and Gideon." },
